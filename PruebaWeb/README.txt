...
a persistence unit "PruebaWebPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "PruebaWeb/pom.xml":
...
artifact ("PruebaWeb.war") is already built. You can build
